        ...
        private async Task<List<ListElevators>> ReadAllAsync(DbDataReader reader)
        {
            ...
            using (reader)
            {
                while (await reader.ReadAsync())
                {
                    ...
                    if (reader.IsDBNull(5)) dCommission_Date = new DateTime(0000, 0, 0); else dCommission_Date = reader.GetDateTime(5);
                    if (reader.IsDBNull(6)) dDate_Of_Last_Inspection = new DateTime(0000, 0, 0); else dDate_Of_Last_Inspection = reader.GetDateTime(6);
                    ...
                    if (reader.IsDBNull(11)) dCreated_at = new DateTime(0000, 0, 0); else dCreated_at = reader.GetDateTime(11);
                    if (reader.IsDBNull(12)) dUpdated_at = new DateTime(0000, 0, 0); else dUpdated_at = reader.GetDateTime(12);
