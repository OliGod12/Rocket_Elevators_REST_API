        ...
        private async Task<List<Buildings>> ReadAllAsync(DbDataReader reader)
        {
            ...
            using (reader)
            {
                while (await reader.ReadAsync())
                {
                    ...
                    if (reader.IsDBNull(9)) dCreated_at = new DateTime(0000, 0, 0); else dCreated_at = reader.GetDateTime(9);
                    if (reader.IsDBNull(10)) dUpdated_at = new DateTime(0000, 0, 0); else dUpdated_at = reader.GetDateTime(10);
